...
const (
	...
	// Fast integer operations (optimized)
	OpAddInt Opcode = 0x27 // Fast integer add: b + a (both ints)
	OpSubInt Opcode = 0x28 // Fast integer subtract
	OpMulInt Opcode = 0x29 // Fast integer multiply
	OpEqInt  Opcode = 0x2A // Fast integer equality
	OpLtInt  Opcode = 0x2B // Fast integer less than
...
var OpcodeTable = map[Opcode]OpcodeInfo{
	...
	OpAddInt: {"ADD_INT", 0, 2, 1}, // Fast integer add
	OpSubInt: {"SUB_INT", 0, 2, 1}, // Fast integer subtract
	OpMulInt: {"MUL_INT", 0, 2, 1}, // Fast integer multiply
	OpEqInt:  {"EQ_INT", 0, 2, 1},  // Fast integer equality
	OpLtInt:  {"LT_INT", 0, 2, 1},  // Fast integer less than
