...
func registerBuiltins(st *SymbolTable) {
	builtins := []string{
		...
		// String functions
		"wordCount", "truncate", "capitalize", "titleCase", "quote", "unquote",
		"containsStr", "startsWith", "endsWith", "indexOf", "lastIndexOf",
		"replaceAll", "split", "trim", "toUpper", "toLower",
		...
		// String validation
		"isAlpha", "isDigit", "isAlnum", "hasSpace", "left", "right", "substring",
		// Hash functions
		...
		"includes", "every", "some", "fill", "first", "last", "tail", "init", "nth", "take", "drop", "takeLast", "dropLast", "insert", "removeAt", "replaceAt", "size", "empty", "clone", "concat", "join", "compact", "rotate", "duplicate", "sliding", "toSorted", "toReversed", "isSorted", "unzip", "sampleSize", "shuffle", "randomFloat", "randomInt", "dropWhile", "takeWhile", "nth",
		// Map functions
