...
func registerBuiltins(st *SymbolTable) {
	builtins := []string{
		...
		"includes", "every", "some", "fill", "first", "last", "tail", "init", "nth", "take", "drop", "takeLast", "dropLast", "insert", "removeAt", "replaceAt", "size", "empty", "clone", "concat", "join", "compact", "rotate", "duplicate", "sliding", "toSorted", "toReversed", "isSorted", "unzip",
		// Map functions
